                ...
                <div class="auth-wrapper auth-v2">
                    <div class="auth-inner row m-0">
                        <!-- Brand logo--><a class="brand-logo" href="javascript:void(0);">
                            ...
                            <h2 class="brand-text text-primary ml-1">App CompraVentas</h2>
                        </a>
                        <!-- /Brand logo-->
                        <!-- Left Text-->
                        ...
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                <h2 class="card-title font-weight-bold mb-1">AppCompraVenta</h2>
                                <p class="card-text mb-2">Por favor ingresa tus credenciales de acceso</p>
                                <form method="POST" action="{{ route('login') }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="nombre_usuario" type="text"
                                            ...
                                            placeholder="usuario123" name="nombre_usuario"
                                    ...
                                    <button class="btn btn-primary btn-block" type="submit" tabindex="4">Iniciar
                                        sesión</button>
                                </form>
                            </div>
                        </div>
