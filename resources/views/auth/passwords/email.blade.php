...
<body class="vertical-layout vertical-menu-modern blank-page navbar-floating footer-static  " data-open="click"
                ...
                <div class="auth-wrapper auth-v2">
                    <div class="auth-inner row m-0">
                        <!-- Brand logo--><a class="brand-logo" href="javascript:void(0);">
                            ...
                            <h2 class="brand-text text-primary ml-1">App CompraVenta</h2>
                        </a>
                        <!-- /Brand logo-->
                        <!-- Left Text-->
                        <div class="d-none d-lg-flex col-lg-8 align-items-center p-5">
                            <div class="w-100 d-lg-flex align-items-center justify-content-center px-5">
                                <img class="img-fluid"
                                    src="{{ asset('dashboard/app-assets/images/pages/forgot-password-v2-dark.svg') }}" />
                            </div>
                        </div>
                        <!-- /Left Text-->
                        @if (session('status'))
                            <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                                <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                    <h2 class="card-title font-weight-bold mb-1">App CompraVenta</h2>
                                    <p class="card-text mb-2">{{ session('status') }}, ve y sigue las instrucciones
                        ...
                        @else
                            ...
                            <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                                <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                    <h2 class="card-title font-weight-bold mb-1">¿Olvido su contraseña?</h2>
                                    <p class="card-text mb-2">Introduzca su correo electrónico y te enviaremos las
                                    ...
                                    <form class="auth-forgot-password-form mt-2" method="POST"
                                        ...
                                        <button type="submit" class="btn btn-primary btn-block" tabindex="2">Enviar link
                                            de restablecimiento</button>
                                    </form>
                                    <p class="text-center mt-2">
                                        <a href="{{ route('login') }}"> <i data-feather="chevron-left"></i> Regresar
                                        </a>
                                    </p>
                                </div>
                            </div>
    ...
    <!-- BEGIN: Page JS-->
    <script src="{{ asset('dashboard/app-assets/js/scripts/pages/page-auth-forgot-password.js') }}"></script>
    <!-- END: Page JS-->
